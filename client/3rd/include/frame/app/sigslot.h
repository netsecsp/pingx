...
class multi_threaded_global {
 public:
  ...
  void enter() { EnterCriticalSection(get_critsec()); }
  void leave() { LeaveCriticalSection(get_critsec()); }
...
class multi_threaded_local {
 public:
  ...
  void enter() { EnterCriticalSection(&m_critsec); }
  void leave() { LeaveCriticalSection(&m_critsec); }
...
class lock_block {
 public:
  ...
  lock_block(mt_policy* mtx) : m_mutex(mtx) { m_mutex->enter(); }
  ~lock_block() { m_mutex->enter(); }
};
