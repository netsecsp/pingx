...
MIDL_DEFINE_GUID(IID, IID_IAsynMessageHolder,0xE765F457,0x4262,0x4F7B,0xBF,0x6D,0x49,0xF7,0x2C,0xD8,0x16,0x98);
...
MIDL_DEFINE_GUID(IID, IID_IDyldProvider,0x94CCE335,0x9F58,0x4624,0xA6,0x33,0xB1,0xFB,0x71,0x8D,0x8D,0xB2);
